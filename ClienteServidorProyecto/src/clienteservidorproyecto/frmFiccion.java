...
public class frmFiccion extends javax.swing.JFrame {
    ...
    if (filaSeleccionada == -1) {
        ...
        int idFiccion = Integer.parseInt(jtFiccion.getValueAt(filaSeleccionada, 0).toString());
        DatosFiccion datosFiccion = new DatosFiccion();
        boolean resultado = datosFiccion.eliminarFiccion(idFiccion);
        if (resultado) {
            JOptionPane.showMessageDialog(this, "Ficción eliminada exitosamente");
            cargarDatos();
        } else {
            JOptionPane.showMessageDialog(this, "Error al eliminar la ficción");
        }
    }
